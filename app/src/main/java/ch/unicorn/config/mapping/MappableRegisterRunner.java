...
public class MappableRegisterRunner implements ApplicationRunner {
	private static final String BASE_PACKAGE = "ch.unicorn.webContext";
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		System.out.println("found mappables:");
		mappables.forEach(clazz -> System.out.println(clazz.getName()));
		...
		System.out.println("found presets:");
		mapperPresetListings.forEach(clazz -> System.out.println(clazz.getName()));
